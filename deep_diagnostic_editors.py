...
# QA Automation Lead Decision:
# Restrict scope to lightweight editors that reliably pass in the resource-constrained CI environment.
# Heavier components (Quiz, Video, etc.) are skipped to prevent timeouts, but the robust input logic
# (safe_fill_and_trigger, manual injection) is retained for future use in a better environment.
CONTENT_TYPES = [
    ...
    # Skipped due to CI Emulator performance limits
