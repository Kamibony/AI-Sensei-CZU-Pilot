...
export class EditorViewAudio extends LitElement {
    ...
    async _generateAudio() {
        ...
        if (!script || script.trim().length === 0) {
            showToast("Prosím napište nejdříve scénář.", "warning");
            return;
        }
        ...
        try {
            ...
            if (result.data.success) {
                showToast("Audio bylo úspěšně vygenerováno!", "success");
                        ...
                        <div class="max-w-5xl mx-auto space-y-6">
                            ...
                            <div class="bg-white rounded-3xl p-8 shadow-sm border border-slate-200 flex flex-col md:flex-row gap-8 items-start">
                                <div class="flex-1">
                                    ...
                                    <p class="text-slate-500">Napište scénář pro podcast. Použijte tagy pro označení mluvčích.</p>
                                ...
                                <div class="w-full md:w-80 bg-slate-50 rounded-2xl p-4 border border-slate-200">
                                    ${this.audioUrl ? html`
                                        ...
                                        <a href="${this.audioUrl}" download="podcast.mp3" class="text-xs text-indigo-600 hover:underline block text-center">Stáhnout MP3</a>
                                    ` : html`
                                        <div class="h-24 flex items-center justify-center text-slate-400 text-sm italic border-2 border-dashed border-slate-200 rounded-lg">
                                            Audio zatím nebylo vygenerováno
                                        </div>
                                    `}
                            ...
                            <div class="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden flex flex-col h-[600px]">
                                ...
                                <textarea
                                    ...
                                    placeholder="[Alex]: Vítejte u dnešního podcastu...\n\n[Sarah]: Ahoj Alexi! Dnes se podíváme na..."
                                    .value="${script}"
