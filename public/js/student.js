...
let currentUserData = null; // Premenná na uloženie dát o študentovi

// Nová exportovaná funkcia na získanie dát o študentovi
...
export async function initStudentDashboard(studentData) {
    currentUserData = studentData; // Uložíme dáta o prihlásenom študentovi
